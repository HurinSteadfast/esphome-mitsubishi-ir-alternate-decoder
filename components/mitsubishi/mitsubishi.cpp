...
bool MitsubishiClimate::on_receive(remote_base::RemoteReceiveData data) {
  ...
  // Temp
  // JP/Fahrenheit remote temperature decoding.
  //
  // The received Mitsubishi frame uses state_frame[7] for temperature, but
  // JP-series Fahrenheit remotes do not encode this as a simple Celsius offset.
  // ESPHome's AEHA dump shows the bit-reversed form of this byte, so these
  // case values are for state_frame[7], not the raw AEHA printed byte.
  int decoded_temp_f = 0;
  switch (state_frame[7]) {
    case 0x00: decoded_temp_f = 61; break;
    case 0x10: decoded_temp_f = 62; break;
    case 0x01: decoded_temp_f = 63; break;
    case 0x11: decoded_temp_f = 64; break;
    case 0x02: decoded_temp_f = 65; break;
    case 0x12: decoded_temp_f = 66; break;
    case 0x03: decoded_temp_f = 67; break;
    case 0x04: decoded_temp_f = 68; break;
    case 0x05: decoded_temp_f = 69; break;
    case 0x15: decoded_temp_f = 70; break;
    case 0x06: decoded_temp_f = 71; break;
    case 0x16: decoded_temp_f = 72; break;
    case 0x07: decoded_temp_f = 73; break;
    case 0x17: decoded_temp_f = 74; break;
    case 0x08: decoded_temp_f = 75; break;
    case 0x18: decoded_temp_f = 76; break;
    case 0x09: decoded_temp_f = 77; break;
    case 0x19: decoded_temp_f = 78; break;
    case 0x0A: decoded_temp_f = 79; break;
    case 0x1A: decoded_temp_f = 80; break;
    case 0x0B: decoded_temp_f = 81; break;
    case 0x1B: decoded_temp_f = 82; break;
    case 0x0C: decoded_temp_f = 83; break;
    case 0x1C: decoded_temp_f = 84; break;
    case 0x0D: decoded_temp_f = 85; break;
    case 0x1D: decoded_temp_f = 86; break;
    case 0x0E: decoded_temp_f = 87; break;
    case 0x0F: decoded_temp_f = 88; break;
    default: break;
  }

  if (decoded_temp_f > 0) {
    this->target_temperature = (decoded_temp_f - 32.0f) * 5.0f / 9.0f;
  } else {
    this->target_temperature = (state_frame[7] & 0x0F) + MITSUBISHI_TEMP_MIN;
  }
